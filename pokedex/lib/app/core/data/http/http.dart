...
abstract class HttpClient {
  Future<dynamic> request(url, {Map<String, String>? headers, dynamic body, required String method});
}

class HttpClientImp implements HttpClient {
  @override
  Future<dynamic> request(url, {Map<String, String>? headers, body, required String method}) async {
    try {
      Response? response;
